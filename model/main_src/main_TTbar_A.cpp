   ...
   /*--------------------------------------------------------------+
    ...
    for(int entry = 0; entry < NEvent; entry++){
       ...
       /*---------------------------------------------------+
        ...
        optm = static_cast<OptiMass::MassMinimizer *>(new OptiMass::TTbar_A);
        optm->InitContainers();
        ...
        */
        ...
        optm->SetInitInvisibleMomentum("w1_m",   );
        optm->SetInitInvisibleMomentum("w2_m",   );    
       ...
       /*-------------------------------------------------------------+
        ...
        alm_controller.UseConstraint(1, true);// (true or false) for the constraint : v1.M() - v2.M() = 0.

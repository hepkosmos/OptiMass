   ...
   /*--------------------------------------------------------------+
    ...
    for(int entry = 0; entry < NEvent; entry++){
       ...
       /*---------------------------------------------------+
        ...
        optm = static_cast<OptiMass::MassMinimizer *>(new OptiMass::hh_minH_hW);
        optm->InitContainers();
       ...
       /*-------------------------------------------------------------+
        ...
        alm_controller.UseConstraint(3, true);// (true or false) for the constraint : w1.M() - 80.419 = 0.

...
+--------------------+-----------------------+
          < Model information >
+--------------------------------------------+
#1) Model Name : 'hh_minH_hZ'
+--------------------------------------------+
#2) Full Decay Topology :
+--------------------------------------------+
    chain-(1) : H - h1 h2 , ( h1 - b1 b2 ) , ( h2 - z1 z2 , ( z1 - e1 e2 ) )
+--------------------------------------------+
...
+--------------------------------------------+
    ...
    constraint-(4) : z1.M() - 80.419 = 0 
    constraint-(5) : z2.M() - 80.419 = 0
+--------------------------------------------*/
#include <cmath>
#include <string>
#include <iostream>
   ...
   /*--------------------------------------------------------------+
    ...
    for(int entry = 0; entry < NEvent; entry++){
       ...
       /*---------------------------------------------------+
        ...
        optm = static_cast<OptiMass::MassMinimizer *>(new OptiMass::hh_minH_hZ);
        optm->InitContainers();
        ...
        */
        ...
        optm->SetInitInvisibleMomentum("z2_m",   );    
       ...
       /*-------------------------------------------------------------+
        ...
        alm_controller.UseConstraint(3, true);// (true or false) for the constraint : z1.M() - 80.419 = 0.
        alm_controller.UseConstraint(4, true);// (true or false) for the constraint : z2.M() - 80.419 = 0.
       ...
       /*-----------------------+
        ...
        std::cout << "z1-mass = " << process_tree.GetSubsystemMass("z1") << std::endl;
        std::cout << "z2-mass = " << process_tree.GetSubsystemMass("z2") << std::endl;
        std::cout << "==================================================" << std::endl;
